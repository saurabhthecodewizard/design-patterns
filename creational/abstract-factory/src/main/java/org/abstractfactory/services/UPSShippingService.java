...
public class UPSShippingService implements ShippingService {
    ...
    public void scheduleShipment(String sender, String recipient, String address, Double weight) {
        ...
        System.out.println("Shipment scheduled by UPS courier service from " + sender + " to " + recipient + " at " + address + ", and the weight is " + weight + ".");
    }
    ...
    public void cancelShipment(UUID shipmentId) {
        ...
        System.out.println("Shipment scheduled by UPS courier service cancelled for UUID: " + shipmentId);
    }
}
